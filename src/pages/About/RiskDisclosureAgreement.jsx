...
const RiskDisclosureAgreement = () => {
  return (
    ...
    >
      ...
      <p>
        Interpretation and Definitions Interpretation This Privacy Policy
      ...
      <p>
        ...
        applicable. Company (referred to as either "the Company", "We", "Us" or
        "Our" in this Agreement) refers to. Affiliate means an entity that
        ...
        or other managing authority. Account means a unique account created for
        You to access our Service or parts of our Service. Website refers to,
        accessible fromhttps://rswin.in/ Service refers to the Website. Country
        refers to: India Service Provider means any natural or legal person who
        ...
        how the Service is used. Third-party Social Media Service refers to any
        website or any social network website through which a User can log in or
        create an account to use the Service. Personal Data is any information
        that relates to an identified or identifiable individual. Cookies are
        ...
        that website among its many uses. Device means any device that can
      ...
      <p>
        ...
        browser. We use both session and persistent Cookies for the purposes set
      ...
      <p>
        ...
        manage Your requests: To attend and manage Your requests to Us. We may
        share your personal information in the following situations: With
        ...
        with You and view Your profile. Illegal win: When you win by illegal
        active like any platform who is giveing you tip or by any other source,
        your withdrawl process will be delayed until the next time you receive a
        notification from the third party service.
      </p>
      ...
      <h5>Disclosure of Your Personal Data Business Transactions</h5>
      <p>
      ...
      <p>
        ...
        that such action is necessary to: Comply with a legal obligation Protect
        and defend the rights or property of the Company Prevent or investigate
